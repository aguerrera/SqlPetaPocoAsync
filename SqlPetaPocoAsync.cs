...
namespace SqlPetaPocoAsync
{
    ...
    public partial class Database : IDisposable
    {
        ...
        {
            _connectionString = new SqlConnectionStringBuilder(connectionString) { AsynchronousProcessing = true }.ToString();
        ...
        {
            return await ExecuteAsync(sql.SQL, sql.Arguments);
        }
        ...
        {
            return await ExecuteScalarAsync<T>(sql.SQL, sql.Arguments);
        }
        ...
        {
            var result = await QueryAsync<T>(sql, args);
        ...
        {
            var result = await FetchAsync<T>(sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        public async Task<Page<T>> PageAsync<T>(long page, long itemsPerPage, string sql, params object[] args)
        {
            string sqlCount, sqlPage;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql, ref args, out sqlCount, out sqlPage);
            var result = await PageAsync<T>(page, itemsPerPage, sqlCount, args, sqlPage, args);
            return result;
        }
        ...
        {
            var result = await PageAsync<T>(page, itemsPerPage, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        {
            var result = await PageAsync<T>(page, itemsPerPage, sqlCount.SQL, sqlCount.Arguments, sqlPage.SQL, sqlPage.Arguments);
            return result;
        }
        ...
        #region operation: FetchAsync (page)
        ...
        {
            var result = await SkipTakeAsync<T>((page - 1) * itemsPerPage, itemsPerPage, sql, args);
            return result;
        }
        ...
        {
            var result = await SkipTakeAsync<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        public async Task<List<T>> SkipTakeAsync<T>(long skip, long take, string sql, params object[] args)
        {
            string sqlCount, sqlPage;
            BuildPageQueries<T>(skip, take, sql, ref args, out sqlCount, out sqlPage);
            var result = await FetchAsync<T>(sqlPage, args);
            return result;
        }
        ...
        {
            var result = await SkipTakeAsync<T>(skip, take, sql.SQL, sql.Arguments);
            return result;
        }
        #endregion
        ...
        {
            var result = await QueryAsync<T>(sql.SQL, sql.Arguments);
            return result;
        }
        ...
        {
            var poco = PocoData.ForType(typeof(T)).TableInfo;
            var result = await ExecuteScalarAsync<int>(string.Format(_dbType.GetExistsSql(), poco.TableName, sqlCondition), args) != 0;
            return result;
        }
        ...
        {
            var result = await ExistsAsync<T>(string.Format("{0}=@0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof(T)).TableInfo.PrimaryKey)), primaryKey);
            return result;
        }
        ...
        #region operation: linq style Async (ExistsAsync, SingleAsync, SingleOrDefaultAsync etc...)
        ...
        {
            var result = await SingleAsync<T>(string.Format("WHERE {0}=@0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof(T)).TableInfo.PrimaryKey)), primaryKey);
            return result;
        }
        ...
        /// If there are no records with the specified primary key value, default(T) (typically null) is returned.
        /// </remarks>
        public async Task<T> SingleOrDefaultAsync<T>(object primaryKey)
        {
            var result = await SingleOrDefaultAsync<T>(string.Format("WHERE {0}=@0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof(T)).TableInfo.PrimaryKey)), primaryKey);
            return result;
        }
        ...
        {
            var result = await InsertAsync(tableName, primaryKeyName, true, poco);
            return result;
        }
        ...
        {
            var pd = PocoData.ForType(poco.GetType());
            var result = await InsertAsync(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, pd.TableInfo.AutoIncrement, poco);
            return result;
        }
        ...
        {
            var result = await UpdateAsync(tableName, primaryKeyName, poco, primaryKeyValue, null);
            return result;
        }
        ...
        {
            var result = await UpdateAsync(tableName, primaryKeyName, poco, null);
            return result;
        }
        ...
        {
            var result = await UpdateAsync(tableName, primaryKeyName, poco, null, columns);
            return result;
        ...
        {
            var result = await UpdateAsync(poco, null, columns);
            return result;
        }
        ...
        {
            var result = await UpdateAsync(poco, null, null);
            return result;
        }
        ...
        {
            var result = await UpdateAsync(poco, primaryKeyValue, null);
            return result;
        }
        ...
        {
            var pd = PocoData.ForType(poco.GetType());
            var result = await UpdateAsync(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, poco, primaryKeyValue, columns);
            return result;
        }
        ...
        {
            var pd = PocoData.ForType(typeof(T));
            var result = await ExecuteAsync(string.Format("UPDATE {0} {1}", _dbType.EscapeTableName(pd.TableInfo.TableName), sql), args);
            return result;
        }
        ...
        {
            var pd = PocoData.ForType(typeof(T));
            var result = await ExecuteAsync(new Sql(string.Format("UPDATE {0}", _dbType.EscapeTableName(pd.TableInfo.TableName))).Append(sql));
            return result;
        }
        #endregion
        ...
        {
            var result = await DeleteAsync(tableName, primaryKeyName, poco, null);
            return result;
        }
        ...
        public async Task<int> DeleteAsync(string tableName, string primaryKeyName, object poco, object primaryKeyValue)
        {
            ...
            var result = await ExecuteAsync(sql, primaryKeyValue);
            return result;
        }
        ...
        {
            var pd = PocoData.ForType(poco.GetType());
            var result = await DeleteAsync(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, poco);
            return result;
        ...
        public async Task<int> DeleteAsync<T>(object pocoOrPrimaryKey)
        {
            ...
            {
                var result = await DeleteAsync(pocoOrPrimaryKey);
                return result;
            }
            else
            {
                var pd = PocoData.ForType(typeof(T));
                var result = await DeleteAsync(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, null, pocoOrPrimaryKey);
                return result;
            }
        }
        ...
        {
            var pd = PocoData.ForType(typeof(T));
            var result = await ExecuteAsync(string.Format("DELETE FROM {0} {1}", _dbType.EscapeTableName(pd.TableInfo.TableName), sql), args);
            return result;
        }
        ...
        {
            var pd = PocoData.ForType(typeof(T));
            var result = await ExecuteAsync(new Sql(string.Format("DELETE FROM {0}", _dbType.EscapeTableName(pd.TableInfo.TableName))).Append(sql));
            return result;
        }
        #endregion
        ...
        /// <param name="primaryKeyName">The name of the primary key column</param>
        /// <param name="poco">The POCO object to be saved</param>
        public async Task SaveAsync(string tableName, string primaryKeyName, object poco)
        {
            if (IsNew(primaryKeyName, poco))
            {
                await InsertAsync(tableName, primaryKeyName, true, poco);
            }
            else
            {
                await UpdateAsync(tableName, primaryKeyName, poco);
            }
        }
        ...
        {
            var pd = PocoData.ForType(poco.GetType());
            await SaveAsync(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, poco);
        }
        #endregion
        ...
        #region operation: Multi-Poco Query/Fetch Async
        /// <summary>
        /// Perform a multi-poco fetch
        /// </summary>
        /// <typeparam name="T1">The first POCO type</typeparam>
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<TRet>> FetchAsync<T1, T2, TRet>(Func<T1, T2, TRet> cb, string sql, params object[] args)
        {
            var result = await QueryAsync<T1, T2, TRet>(cb, sql, args);
            return result.ToList();
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<TRet>> FetchAsync<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, string sql, params object[] args)
        {
            var result = await QueryAsync<T1, T2, T3, TRet>(cb, sql, args);
            return result.ToList();
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<TRet>> FetchAsync<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, string sql, params object[] args)
        {
            var result = await QueryAsync<T1, T2, T3, T4, TRet>(cb, sql, args);
            return result.ToList();
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<TRet>> QueryAsync<T1, T2, TRet>(Func<T1, T2, TRet> cb, string sql, params object[] args)
        {
            var result = await QueryAsync<TRet>(new Type[] { typeof(T1), typeof(T2) }, cb, sql, args);
            return result;
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<TRet>> QueryAsync<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, string sql, params object[] args)
        {
            var result = await QueryAsync<TRet>(new Type[] { typeof(T1), typeof(T2), typeof(T3) }, cb, sql, args);
            return result;
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<TRet>> QueryAsync<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, string sql, params object[] args)
        {
            var result = await QueryAsync<TRet>(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, cb, sql, args);
            return result;
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<TRet>> FetchAsync<T1, T2, TRet>(Func<T1, T2, TRet> cb, Sql sql)
        {
            var result = await QueryAsync<T1, T2, TRet>(cb, sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<TRet>> FetchAsync<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, Sql sql)
        {
            var result = await QueryAsync<T1, T2, T3, TRet>(cb, sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<TRet>> FetchAsync<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, Sql sql)
        {
            var result = await QueryAsync<T1, T2, T3, T4, TRet>(cb, sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<TRet>> QueryAsync<T1, T2, TRet>(Func<T1, T2, TRet> cb, Sql sql)
        {
            var result = await QueryAsync<TRet>(new Type[] { typeof(T1), typeof(T2) }, cb, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<TRet>> QueryAsync<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, Sql sql)
        {
            var result = await QueryAsync<TRet>(new Type[] { typeof(T1), typeof(T2), typeof(T3) }, cb, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<TRet>> QueryAsync<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, Sql sql)
        {
            var result = await QueryAsync<TRet>(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, cb, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<T1>> FetchAsync<T1, T2>(string sql, params object[] args)
        {
            var result = await QueryAsync<T1, T2>(sql, args);
            return result.ToList();
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<T1>> FetchAsync<T1, T2, T3>(string sql, params object[] args)
        {
            var result = await QueryAsync<T1, T2, T3>(sql, args);
            return result.ToList();
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<T1>> FetchAsync<T1, T2, T3, T4>(string sql, params object[] args)
        {
            var result = await QueryAsync<T1, T2, T3, T4>(sql, args);
            return result.ToList();
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<T1>> QueryAsync<T1, T2>(string sql, params object[] args)
        {
            var result = await QueryAsync<T1>(new Type[] { typeof(T1), typeof(T2) }, null, sql, args);
            return result;
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<T1>> QueryAsync<T1, T2, T3>(string sql, params object[] args)
        {
            var result = await QueryAsync<T1>(new Type[] { typeof(T1), typeof(T2), typeof(T3) }, null, sql, args);
            return result;
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<T1>> QueryAsync<T1, T2, T3, T4>(string sql, params object[] args)
        {
            var result = await QueryAsync<T1>(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, null, sql, args);
            return result;
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<T1>> FetchAsync<T1, T2>(Sql sql)
        {
            var result = await QueryAsync<T1, T2>(sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<T1>> FetchAsync<T1, T2, T3>(Sql sql)
        {
            var result = await QueryAsync<T1, T2, T3>(sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as a List</returns>
        public async Task<List<T1>> FetchAsync<T1, T2, T3, T4>(Sql sql)
        {
            var result = await QueryAsync<T1, T2, T3, T4>(sql.SQL, sql.Arguments);
            return result.ToList();
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<T1>> QueryAsync<T1, T2>(Sql sql)
        {
            var result = await QueryAsync<T1>(new Type[] { typeof(T1), typeof(T2) }, null, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<T1>> QueryAsync<T1, T2, T3>(Sql sql)
        {
            var result = await QueryAsync<T1>(new Type[] { typeof(T1), typeof(T2), typeof(T3) }, null, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<IEnumerable<T1>> QueryAsync<T1, T2, T3, T4>(Sql sql)
        {
            var result = await QueryAsync<T1>(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, null, sql.SQL, sql.Arguments);
            return result;
        }
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL</param>
        /// <returns>A collection of POCO's as an IEnumerable</returns>
        public async Task<List<TRet>> QueryAsync<TRet>(Type[] types, object cb, string sql, params object[] args)
        {
            await OpenSharedConnectionAsync();
        ...
        #region Internal operations Async
